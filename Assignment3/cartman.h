 ...
 *
 * Return is optional, i.e. entering an infinite loop is allowed, if not 
 * exactly recommended. Some implementations will do nothing here, most
 * will initialise necessary components.
 */
void cartman();
